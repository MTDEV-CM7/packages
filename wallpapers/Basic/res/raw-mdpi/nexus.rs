...
#define PULSE_SIZE           7 // Size in pixels of a cell
#define HALF_PULSE_SIZE      4
#define GLOW_SIZE            48 // Size of the leading glow in pixels
#define HALF_GLOW_SIZE       24
#define SPEED                0.12f // (200 / 1000) Pixels per ms
#define SPEED_VARIANCE       0.2f
#define PULSE_NORMAL         0
#define PULSE_EXTRA          1
#define TRAIL_SIZE           32 // Number of cells in a trail
